                        ...
                        <div className="w-[30%]">
                            <div className="pr-3 text-[#d0d2d6] text-lg">
                                <div className="flex flex-col gap-1">
                                    <h2 className="pb-2 font-semibold">Deliver To : NGO TRONG LIEM</h2>
                                    <p><span className='text-sm'>Thon Giao Lac, xa Thai Tho, Huyen Thai THuy, Tinh Thai Binh</span></p>
                                </div>
                                    ...
                                    <div className="text-[#d0d2d6]">
                                        <div className="flex gap-3 text-md">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-lg">Quantity: 3</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
